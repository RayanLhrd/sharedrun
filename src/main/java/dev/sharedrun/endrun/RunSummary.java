...
public class RunSummary {
    ...
    public List<String> participants = new ArrayList<>(); // pseudos joueurs présents au moment de la fin de run (non-spec)
    ...
    public String topChef;          // joueur qui a mangé le plus d'aliments normaux (regen team)
    public int topChefCount;
    public String topRotten;        // joueur qui a mangé le plus de chairs putréfiées (debuff team)
